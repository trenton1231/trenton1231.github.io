const apiURL = "https://api.openweathermap.org/data/2.5/weather?id=5607916&appid=8b53852779ab7526edc0a9a6eacc15cd&units=imperial";
fetch(apiURL)
...
const apiURLs = "https://api.openweathermap.org/data/2.5/forecast?id=5607916&APPID=8b53852779ab7526edc0a9a6eacc15cd&units=imperial";
fetch(apiURLs)
    .then((response) => response.json())
    .then((jsObject) => {
